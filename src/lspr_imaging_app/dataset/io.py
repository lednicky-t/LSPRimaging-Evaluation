...
# ImageDataset/ImageKey/ImageRecord: the rewrite's own copy (ported verbatim
# from domain/models.py - see dataset/model.py's docstring), not the
# develop/main-branch original. Everything below is *not yet ported* and is
# intentionally still imported from its current develop/main-branch location
# - this module doesn't wire into the old app anywhere, so depending on
