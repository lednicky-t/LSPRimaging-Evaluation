...
SHORTCUT_SECTIONS: tuple[ShortcutSection, ...] = (
    ShortcutSection(
        ...
        lines=(
            ...
            "Middle-drag: Pan the image view (works in every image tool/mode)",
            "Mouse wheel over the image: Zoom in or out",
        ),
    ),
    ShortcutSection(
        key="dataset",
    ...
    ShortcutSection(
        ...
        lines=(
            ...
            "Double-left-click: Place the current reference point at the cursor",
            "Right-drag: Move an existing reference point",
            "Right-click (no drag): Open the point menu (Clear this point)",
            "Middle-drag: Pan the image view",
