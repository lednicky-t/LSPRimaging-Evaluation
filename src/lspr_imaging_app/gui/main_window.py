...
class MainWindow(MainWindowIcons, RoiGeometryMixin, MeasurementCalibrationMixin, QMainWindow):
    ...
    def _init_dataset_widgets(self, default_folder: Path) -> None:
        ...
        self.dataset_ome_zarr_chunk_estimate_row = QWidget(self)
        dataset_ome_zarr_chunk_estimate_layout = QHBoxLayout(self.dataset_ome_zarr_chunk_estimate_row)
        dataset_ome_zarr_chunk_estimate_layout.setContentsMargins(0, 0, 0, 0)
        dataset_ome_zarr_chunk_estimate_layout.setSpacing(4)
        dataset_ome_zarr_chunk_estimate_layout.addWidget(self.ome_zarr_chunk_estimate_label)
        dataset_ome_zarr_chunk_estimate_layout.addStretch(1)
    ...
    def _processing_state_signature(self) -> str:
        ...
        payload = {
            ...
            "detected_rois": [_roi_signature_entry(roi) for roi in self._state.area_rois],
